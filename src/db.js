...
const sequelize = new Sequelize(
  `postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/tienda_de_ropa`,
  {
...
fs.readdirSync(modelsDirectory)
  ...
  .forEach((file) => {
    ...
    if (fs.existsSync(filePath)) {
      ...
      console.error(
        `Error: File '${file}' does not exist in 'Models' directory.`
      );
      process.exit(1);
    }
  });
...
const products = [
  {
    ...
    name: "Elegante",
    Imagen_URL:
      "https://i.pinimg.com/564x/54/6b/41/546b410f8cfcdc4fde7f2facf5644ea2.jpg",
    onOffer: "true",
    Brand: "Elegancia",
  },
  {
    ...
    name: "Elegante",
    Imagen_URL:
      "https://i.pinimg.com/736x/92/14/d7/9214d740ef344a3f1cbd62bd5e8ce8ae.jpg",
    onOffer: false,
    Brand: "Nocturna",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/564x/97/02/cb/9702cbf2cb64ad7d4bd740ede025578d.jpg",
    onOffer: true,
    Brand: "Verano",
  },
  {
    ...
    name: "Deportivo",
    Imagen_URL:
      "https://i.pinimg.com/564x/bb/97/ac/bb97ac9f15bdf53a880aba6fd5fcd10d.jpg",
    onOffer: false,
    Brand: "Fitness",
  },
  {
    ...
    name: "Formal",
    Imagen_URL:
      "https://i.pinimg.com/564x/c3/7f/94/c37f9473f416a01c1d758682d48865df.jpg",
    onOffer: true,
    Brand: "Primavera",
  },
  {
    ...
    name: "Elegante",
    Imagen_URL:
      "https://i.pinimg.com/736x/2d/f7/72/2df772084cf07852f33f1944f2d0b8a2.jpg",
    onOffer: false,
    Brand: "Elegancia",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/736x/00/0d/08/000d0831f3baea89b7dd6284abbd3095.jpg",
    onOffer: true,
    Brand: "Urban",
  },
  {
    ...
    name: "Elegante",
    Imagen_URL:
      "https://i.pinimg.com/564x/bf/f4/2c/bff42cbd9be59d3b421d1798af7e78c3.jpg",
    onOffer: false,
    Brand: "Atrevida",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/564x/ae/20/74/ae2074cd7db542cf9d871ee84ee88c9f.jpg",
    onOffer: true,
    Brand: "Verano",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/564x/be/a3/47/bea3479a622bd2b5b9572f8652bc46fa.jpg",
    onOffer: false,
    Brand: "Casual",
  },
  {
    ...
    name: "Elegante",
    Imagen_URL:
      "https://i.pinimg.com/564x/36/0c/ea/360ceae18f6218c6332b1e267b738a65.jpg",
    onOffer: true,
    Brand: "Glamour",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/736x/31/01/06/3101063d2027e012d4feb1c09c353f7e.jpg",
    onOffer: false,
    Brand: "Alegre",
  },
  {
    ...
    name: "Casual",
    Imagen_URL:
      "https://i.pinimg.com/564x/05/9f/3f/059f3fd9a42946757afc646c0132cac1.jpg",
    onOffer: true,
    Brand: "Desenfadado",
  },
];
